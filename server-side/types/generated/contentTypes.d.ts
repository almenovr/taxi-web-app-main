...
export interface ApiCarCar extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    carImg: Schema.Attribute.Media<'images'>;
    ...
    >;
    isBusiness: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    listCars: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
